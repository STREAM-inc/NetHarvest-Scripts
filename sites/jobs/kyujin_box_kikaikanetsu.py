"""
求人ボックス（機械金属 - 一都三県）スクレイパー

取得対象:
    - 機械金属の仕事（東京都・神奈川県・埼玉県・千葉県）

取得フロー:
    /adv/ キーワード+エリア検索URL → 一覧カード（data-func-show-arg JSON）+ 内部詳細ページ補完

実行方法:
    # ローカルテスト
    python scripts/sites/jobs/kyujin_box_kikaikanetsu.py

    # Prefect Flow 経由
    python bin/run_flow.py --site-id kyujin_box_kikaikanetsu
"""
...
LIST_URL = (
    "https://xn--pckua2a7gp15o89zb.com/adv/"
    "?keyword=%E6%A9%9F%E6%A2%B0%E9%87%91%E5%B1%9E"
    "&area=%E6%9D%B1%E4%BA%AC%E9%83%BD%20or:%E7%A5%9E%E5%A5%88%E5%B7%9D%E7%9C%8C"
    "%20or:%E5%9F%BC%E7%8E%89%E7%9C%8C%20or:%E5%8D%83%E8%91%89%E7%9C%8C"
)
...
class KyujinBoxKikaiKanetsuScraper(StaticCrawler):
    """求人ボックス（機械金属 - 一都三県）スクレイパー"""
...
if __name__ == "__main__":
    ...
    scraper = KyujinBoxKikaiKanetsuScraper()
