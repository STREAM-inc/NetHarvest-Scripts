...
# 社宅 keyword search
START_URL = "https://next.rikunabi.com/job_search/kw/%E7%A4%BE%E5%AE%85/"
...
class RikunabiNextSyatakuScraper(DynamicCrawler):
    """リクナビNEXT 社宅あり求人 企業情報スクレイパー（next.rikunabi.com）"""
    ...
    def _collect_detail_urls(self, start_url: str) -> list[str]:
        ...
        while current:
            ...
            # cursor-based pagination or next link
...
if __name__ == "__main__":
    ...
    RikunabiNextSyatakuScraper().execute(START_URL)
